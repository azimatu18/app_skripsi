...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header" style="background-color: #003366; color: white;">
            <strong><i class="bi bi-pencil-fill me-2"></i>Detail produk</strong>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-12">
                    ...
                    <textarea name="alasan" class="form-control" rows="4"><?= esc($produk['deskripsi']) ?></textarea>
                </div>
            </div>

            <div class="mt-4 d-flex justify-content-end gap-1">
                <button class="btn btn-blue px-4">
                    <i class="bi bi-save2 me-1"></i> Disetujui
                </button>
                <a href="<?= base_url('/admin/produk') ?>" class="btn btn-secondary">Ditolak</a>
            </div>
        </div>
    </div>
</div>
